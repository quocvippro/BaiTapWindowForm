...
# Tạo script để gán IPv6 vào eth0
gen_ifconfig() {
    cat <<EOF
...
echo "Internal IPv4 = ${IP4}, External subnet for IPv6 = ${IP6}"
...
# Cấu hình tự động chạy proxy khi khởi động
